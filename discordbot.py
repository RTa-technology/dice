...
@bot.command(name="l4176")
async def s4176(ctx: str):
    global HP_4176
    global MP_4176
    global SA_4176

    msg = f"耐久力 {HP_4176}/12. MP {MP_4176}/11.  正気度 {SA_4176}/99."
    await ctx.send(msg)
    
@bot.command(name="k0864")
...
@bot.command(name="e4560")
async def s4176(ctx: str):
    global HP_4560
    global MP_4560
    global SA_4560

    msg = f"耐久力 {HP_4560}/12. MP {MP_4560}/11.  正気度 {SA_4560}/99."
    await ctx.send(msg)

@bot.command(name="r4091")
async def s4176(ctx: str):
    global HP_4091
    global MP_4091
    global SA_4091

    msg = f"耐久力 {HP_4091}/12. MP {MP_4091}/11.  正気度 {SA_4091}/99."
    await ctx.send(msg)

@bot.command(name="rp4091")
async def s4176(ctx, stu: str):
    global HP_4091
    global MP_4091
    global SA_4091
